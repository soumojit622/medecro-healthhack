...
training_dataset = pd.read_csv(r'E:\medecro-healthhack-project\Training.csv')
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1 = Label(self, text="Argha Bandyopadhyay",
                              bg="yellow1", width="250", height="1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2 = Label(self, text="Soumojit Banerjee",
                              bg="yellow2", width="250", height="1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3 = Label(self, text="Subham Biswas", bg="yellow1",
                              width="250", height="1", font=("Calibri", 13))
        self.lblTeam3.pack()
